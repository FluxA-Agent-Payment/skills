# Integrate Video Generation with VEO 3.1 API

**API Endpoint:** `https://proxy-monetize.fluxapay.xyz/api/video-generation-with-veo-3-1`
...
```bash
curl -H "X-Payment: <xPaymentB64>" https://proxy-monetize.fluxapay.xyz/api/video-generation-with-veo-3-1/<endpoint>
```
...
7. **Make API request:** `curl https://proxy-monetize.fluxapay.xyz/api/video-generation-with-veo-3-1/<endpoint>`
