# Integrate OpenAI API Endpoints API

**API Endpoint:** `https://proxy-monetize.fluxapay.xyz/api/openai-api-endpoints`
...
```bash
curl -H "X-Payment: <xPaymentB64>" https://proxy-monetize.fluxapay.xyz/api/openai-api-endpoints/<endpoint>
```
...
7. **Make API request:** `curl https://proxy-monetize.fluxapay.xyz/api/openai-api-endpoints/<endpoint>`
