# Integrate KLing I2V API

**API Endpoint:** `https://proxy-monetize.fluxapay.xyz/api/kling-i2v`
...
```bash
curl -H "X-Payment: <xPaymentB64>" https://proxy-monetize.fluxapay.xyz/api/kling-i2v/<endpoint>
```
...
7. **Make API request:** `curl https://proxy-monetize.fluxapay.xyz/api/kling-i2v/<endpoint>`
