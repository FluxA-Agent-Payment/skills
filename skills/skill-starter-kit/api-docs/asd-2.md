...
**API Endpoint:** `https://proxy.fluxapay.xyz/api/asd-2`
...
```bash
curl -H "X-Payment: <xPaymentB64>" https://proxy.fluxapay.xyz/api/asd-2/<endpoint>
```
...
7. **Make API request:** `curl https://proxy.fluxapay.xyz/api/asd-2/<endpoint>`
