...
- **Proxy URL:** `https://proxy.fluxapay.xyz/api/grok-api-call`
- **Description:** API for calling grok
- **Discovery:** `curl https://proxy.fluxapay.xyz/api/grok-api-call`
...
- **Proxy URL:** `https://proxy.fluxapay.xyz/api/video-generation-with-veo-3-1`
- **Description:** Using Google's veo 3.1 to generate videos
- **Discovery:** `curl https://proxy.fluxapay.xyz/api/video-generation-with-veo-3-1`
