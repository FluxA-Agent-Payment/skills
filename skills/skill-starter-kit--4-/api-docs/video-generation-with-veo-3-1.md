...
**API Endpoint:** `https://proxy.fluxapay.xyz/api/video-generation-with-veo-3-1`
...
```bash
curl -H "X-Payment: <xPaymentB64>" https://proxy.fluxapay.xyz/api/video-generation-with-veo-3-1/<endpoint>
```
...
7. **Make API request:** `curl https://proxy.fluxapay.xyz/api/video-generation-with-veo-3-1/<endpoint>`
