...
**API Endpoint:** `https://proxy.fluxapay.xyz/api/grok-api-call`
...
```bash
curl -H "X-Payment: <xPaymentB64>" https://proxy.fluxapay.xyz/api/grok-api-call/<endpoint>
```
...
7. **Make API request:** `curl https://proxy.fluxapay.xyz/api/grok-api-call/<endpoint>`
