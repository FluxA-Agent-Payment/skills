...
- **AI-generated images** using Nano Banana API with x402 micropayments (0.1 USDC per image)
...
```json
{
  ...
  "payTo": "0x2f9626624A566FEc77719ae826D511D34932C3f4",
  "host": "proxy-monetize.fluxapay.xyz",
  "resource": "https://proxy-monetize.fluxapay.xyz/api/b7da8911-ab69-4577-9d90-f9ae6ca34bfa",
  "description": "API access: /gen-image",
  "tokenName": "USD Coin",
  "tokenVersion": "2",
  "validityWindowSeconds": 120
}
```
